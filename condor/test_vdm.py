...
output_base = f'/eos/home-d/dmbelyts/root_out5/{run}/'  # EOS output
log_dir = "logs"
...
run_query = f'dasgoclient -query="file dataset=/L1Scouting/Run2025D-v1/L1SCOUT run={run}" | sed "s|^|root://cms-xrd-global.cern.ch/|" > run_list/{run}.txt'
